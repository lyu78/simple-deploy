...
rem Держи этот файл в tools\windows_task_scheduler и запускай его из Task Scheduler.
...
".venv\Scripts\python.exe" tools\windows_pipeline.py pipeline >>"%WRAPPER_LOG%" 2>&1
set "RC=%ERRORLEVEL%"
