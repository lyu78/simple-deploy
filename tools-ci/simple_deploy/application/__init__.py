...
jobs. Он принимает уже разобранные команды или request-модели, вызывает
process/use-case реализации и возвращает результат без знания о HTTP, argparse
dispatch или SQLite schema details.
